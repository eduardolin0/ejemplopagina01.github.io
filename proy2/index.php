    ...
    <body id="page-top">
            ...
            <div class="container"><a class="navbar-brand js-scroll-trigger" href="#page-top">AVSI - Inventario Automotriz</a>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="#portfolio">Iniciar sesi&oacute;n</a>
                        </li>
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                ...
                <!-- Masthead Heading-->
                <h1 class="masthead-heading mb-0">Inicio de sesi&oacute;n</h1>
                <!-- Icon Divider-->
        ...
        <section class="page-section portfolio" id="portfolio">
            <div class="container">
                ...
                <div class="text-center">
                    <h2 class="page-section-heading text-secondary mb-0 d-inline-block">Por favor, inicie sesión para ingresar al sistema...</h2>
                </div>
                <!-- Icon Divider-->
                ...
                <div class="row justify-content-center">
                    ...
                    <form action="acceso.php" method="POST">
                    	<div align ="center">
                    		...
                    		<input type="text" name="txtUsr" required><br>
                    		Contrase&ntilde;a:<br>
                    		<input type="password" name="txtPwd" required><br>
                    		<input type="hidden" name="txtLogin" value="1">
