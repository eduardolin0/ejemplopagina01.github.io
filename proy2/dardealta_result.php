        ...
        <section class="page-section portfolio" id="portfolio">
            <div class="container">
                ...
                <div class="text-center">
                    <h2 class="page-section-heading text-secondary mb-0 d-inline-block">Alta de un artÃ­culo</h2>
                </div>
                <!-- Icon Divider-->
                ...
                <div class="row justify-content-center">
                    ...
                    <?php
						...
						$txtFecha = date("Y-m-d", strtotime($_POST['txtFecha']));

                        $serverName = 'HPLNWRKST';   /*AquÃ­ debes poner el nombre de tu servidor si es local, usa LOCAL Ã³ tal como aparece en tu sqlserver*/
                        $connectionInfo = array( 'Database'=>'proyectodos', 'UID'=>'sbd', 'PWD'=>'1234'); /*AquÃ­ vas a poner la base de datos que quieres consultar*/
                        ...
                        $tsql = "INSERT INTO tbinvauto (marca, tipoauto, modelo, transmision, nombre, fechaStock) values ('$txtMarca','$txtTipoAuto',$txtAno,'$txtTipoTransm','$txtNombre', '$txtFecha')";   
                        ...
                        if ( $stmt ){    
                        // Redirect browser 
                            echo '<br><b> Se han insertado los datos correctamente para su nuevo artÃ­culo </b>';
                        }     
                        else{    
                    ...
                    <div></div>
                                ...
                                <div align="center"><a href='dardealta.php' class='botonazul'>Otra Alta</a> 
                                    <a href='acceso_ok.php' class='botonnaranja'>Volver</a> 
                    </div>
        </section>
        <!-- Portfolio Modal-->
