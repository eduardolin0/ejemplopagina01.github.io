        ...
        <section class="page-section portfolio" id="portfolio">
            <div class="container">
                ...
                <div class="text-center">
                    <h2 class="page-section-heading text-secondary mb-0 d-inline-block">Cambiar datos de un autom&oacute;vil</h2>
                </div>
                <!-- Icon Divider-->
                ...
                <div class="row justify-content-center">
                    ...
                    <?php
                      ...
                      $tsql = "SELECT * FROM tbinvauto";   
                      $resultado = sqlsrv_query($conectar, $tsql);

                      $tsqla = "SELECT marca FROM tbmarca";   
                      $result = sqlsrv_query($conectar, $tsqla);

                      $tsqlb = "SELECT tipoauto FROM tbtipo";
                      $resultb = sqlsrv_query($conectar,$tsqlb);

                      $tsqlc = "SELECT ano FROM tbano";
                      $resultc = sqlsrv_query($conectar,$tsqlc);

                      $tsqld = "SELECT tipotransm FROM tbtipotransm";
                      $resultd = sqlsrv_query($conectar,$tsqld);
                    ...
                    <table class="demo">
                        ...
                        <tr>
                            ...
                            <th>Marca</th>
                            <th>TipoAuto</th>
                            <th>Modelo del autom&oacute;vil</th>
                            <th>Tipo de transmisi&oacute;n</th>
                            <th>Nombre del auto</th>
                            <th>&iquest;Hacer cambios?</th>
                        </tr>
                        </thread>
                        <tbody>
                          <?php 
                            while($mostrar = sqlsrv_fetch_array( $resultado, SQLSRV_FETCH_ASSOC)){
                               $idvarauto = $mostrar['idauto'];
                               $idon = isset($_GET['id']) ? $_GET['id'] : null ;;
                               $editaon =isset($_GET['edita']) ? $_GET['edita'] : null ;;
                               if($editaon == true && $idvarauto == $idon){
                                ?>
                                <form action="accion.php" method="post">
                                <input type="hidden" name="txtIdAuto" value="<?php echo $idvarauto; ?>">
                                <tr>
                                    <td><?php echo $mostrar['idauto']; ?></td>
                                    <td><center><?php

                                        echo "<select name='txtMarca' required>";
                                    ...
                                    <td><center><?php
                                        ...
                                        echo "<select name='txtTipoAuto' required>";
                                        while ($row = sqlsrv_fetch_array( $resultb, SQLSRV_FETCH_ASSOC)) {
                                            echo "<option value='" . $row['tipoauto'] . "'>" . $row['tipoauto'] . "</option>";
                                        }
                                        echo "</select>";
                                    ...
                                    <td><center><?php
                                        ...
                                        echo "<select name='txtAno' required>";
                                    ...
                                    <td><center><?php
                                        ...
                                        echo "<select name='txtTipoTransm' required>";
                                        while ($row = sqlsrv_fetch_array( $resultd, SQLSRV_FETCH_ASSOC)) {
                                            echo "<option value='" . $row['tipotransm'] . "'>" . $row['tipotransm'] . "</option>";
                                        }
                                        echo "</select>";
                                        ...
                                        ?></center></td>
                                    <td><input type="text" name="txtNombre" value="<?php echo $mostrar['nombre']; ?>" required></td>
                                    <td><input type="submit" value="Editar"/></form></td>
                                    </tr>
                        ...
                        <tr>
                                ...
                                <td><?php echo $mostrar['tipoauto'] ?></td>
                                <td><?php echo $mostrar['modelo'] ?></td>
                                <td><?php echo $mostrar['transmision'] ?></td>
                                <td><?php echo $mostrar['nombre'] ?></td>
                                <td><a href="cambios.php?edita=true&id=<?php echo $mostrar['idauto']; ?>">Editar</td>
                        </tr>
                        <?php 
                            }
                        }
                ...
                <br>
                <div align="center"><a href='acceso_ok.php' class='botonnaranja'>Volver</a></div>
                <br>
            </div>
        </section>
        <!-- Portfolio Modal-->
