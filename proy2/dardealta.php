        ...
        <section class="page-section portfolio" id="portfolio">
            <div class="container">
                ...
                <div class="text-center">
                    <h2 class="page-section-heading text-secondary mb-0 d-inline-block">Alta de un automóvil</h2>
                </div>
                <!-- Icon Divider-->
                ...
                <div class="row justify-content-center">
                    <!-- Portfolio Items-->
                    <form action="dardealta_result.php" method="POST">
                    <table class="demo">
                        <thread>
                        <tr>
                            <th>Marca</th>
                ...
                <div align="center">
                    <br>
                    <input type="submit" value="Agregar"/> <a href='acceso_ok.php' class='botonnaranja'>Volver</a>
                    </form>
                </div>
            </div>
        </section>
