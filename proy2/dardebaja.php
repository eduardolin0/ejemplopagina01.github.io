    ...
    <body id="page-top">
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                <!-- Masthead Avatar Image--><img class="masthead-avatar mb-5" src="assets/img/IsNVENTORY_MANAGEMENT-512.gif" alt="">
                <!-- Masthead Heading-->
        ...
        <section class="page-section portfolio" id="portfolio">
            <div class="container">
                ...
                <div class="text-center">
                    <h2 class="page-section-heading text-secondary mb-0 d-inline-block">Baja de un autom&oacute;vil</h2>
                </div>
                <!-- Icon Divider-->
                ...
                <div class="row justify-content-center">
                    ...
                    <form action="dardebaja_result.php" METHOD="POST">
                    <?php
                    ...
                    <table class="demo">
                        ...
                        <tr>
                                ...
                                <td><a href="accion.php?borra=true&id=<?php echo $mostrar['idauto']; ?>">Eliminar</td>
                        </tr>
                        <?php 
